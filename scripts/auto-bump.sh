#!/usr/bin/env bash
# Bump the package to a new upstream BCHD release, commit it to master and
# release it.
#
...
# BCHD_VERSION` in the Dockerfile, then commits the bump to master; Check
# Upstream then dispatches Tag and Release.
#
